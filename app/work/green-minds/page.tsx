...
export const metadata: Metadata = {
  title: "Green Minds Case Study",
  description:
    "Web design and sustainability platform for Green Minds NGO. Clean typography, trust metrics, and community involvement portal.",
};

export default function GreenMindsPage() {
  return (
    <main className="bg-background relative min-h-screen selection:bg-primary/30">
      ...
      <section className="relative z-10 px-4 pb-16 pt-32 sm:px-6 sm:pb-24 sm:pt-40 border-b border-border/50">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="text-sm font-bold tracking-widest uppercase text-primary mb-4">NGO Website / Sustainability Brand</p>
          ...
          <p className="mt-6 text-xl text-muted/90 font-medium leading-relaxed">
            Modern nonprofit platform focused on environmental sustainability, trust, awareness, and community impact.
          </p>
          <div className="mt-8">
            <a
            ...
            <div className="md:col-span-2 space-y-12">
              <div>
                ...
                <p className="text-muted leading-relaxed">
                  Green Minds NGO wanted an online platform that would elevate their environmental campaigns. We developed a modern, narrative-driven site emphasizing trust, transparency, and clean visual communication to encourage community contributions and volunteer sign-ups.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted leading-relaxed">
                  Nonprofit websites need to quickly capture visitor trust. The challenge lay in structuring donation CTAs, project timelines, and impact figures into a compelling visual layout that works flawlessly across all devices.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted leading-relaxed">
                  We engineered a responsive sitemap using clean, accessible typography and custom-themed Tailwind layout components. Fully optimized SVG iconography and high-speed page templates help Green Minds broadcast their sustainability initiatives globally with Zero loading friction.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-8">
              <div className="rounded-2xl border border-border/50 bg-surface/30 p-6 backdrop-blur-xl">
                ...
                <dl className="space-y-4 text-sm">
                  <div>
                    ...
                    <dd className="text-white font-medium mt-1">Green Minds</dd>
                  </div>
                  <div>
                    <dt className="text-muted">Services</dt>
                    <dd className="text-white font-medium mt-1">UX/UI Design, Frontend Development</dd>
                  </div>
                  <div>
              ...
              <div className="rounded-2xl border border-border/50 bg-surface/30 p-6 backdrop-blur-xl space-y-4">
                ...
                <div className="flex gap-3">
                  ...
                  <p className="text-sm text-muted">Stronger visibility for environmental campaigns and programs.</p>
                </div>
                <div className="flex gap-3">
                  <ShieldCheck className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                  <p className="text-sm text-muted">Clean structure validating nonprofit integrity and projects.</p>
                </div>
                <div className="flex gap-3">
                  <Sparkles className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                  <p className="text-sm text-muted">Increased organic conversions for volunteers and partners.</p>
                </div>
              </div>
            </div>
          </div>
